# Generated by Django 4.0.4 on 2022-04-14 17:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('categoryThought', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='NewsApp.category')),
                ('postThought', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='NewsApp.post')),
            ],
        ),
        migrations.AddField(
            model_name='post',
